...
var VimToggleSettingsTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl).setName("GitHub").setDesc("Go to my GitHub profile.").addButton(
      (button) => button.setButtonText("Go to GitHub").setCta().onClick(
        () => {
