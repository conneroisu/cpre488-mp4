...
var GitFileExplorerSettingTab = class extends import_obsidian3.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian3.Setting(containerEl).setName("Changed files style").setDesc("Choose how changed files should be highlighted in the file explorer").addDropdown(
